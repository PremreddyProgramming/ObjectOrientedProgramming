...
public class RiskMatrix implements RiskIterable<RiskMatrixEntry>{
	...
	@Override
	public RiskIterator<RiskMatrixEntry> getIterator() {
		return new RiskMatrixEntryIterator();
	}

	class RiskMatrixEntryIterator implements RiskIterator<RiskMatrixEntry> {
